...
import com.lab.esh1n.weather.presentation.common.LocalisedContextProvider
import com.lab.esh1n.weather.presentation.mapper.PlaceWeatherListMapper
...
class AllPlacesVM @Inject constructor(
    ...
    fun saveCurrentPlace(id: Int) {
        ...
        updateCurrentPlaceUseCase.perform(id)
            .flatMap {
                loadCurrentPlaceUseCase.perform()
            }
            .doOnSubscribe { _ ->
                updateCurrentPlaceOperation.postValue(Resource.loading())
            }
            ...
            .subscribe({ result ->
                ...
                updateCurrentPlaceOperation.postValue(Resource.success(result))
            }, {
